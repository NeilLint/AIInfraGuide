...
🆕 在此基础上，**3.10 现代注意力机制演进**把注意力变种一路讲到当前前沿：MLA 的矩阵吸收与解耦 RoPE、滑动窗口与 Attention Sink、线性注意力混合架构、NSA/MoBA/DSA 可训练稀疏注意力，以及 DeepSeek V4 支撑 1M 上下文的 CSA+HCA 混合注意力——这些是当下面试中模型架构方向的最高频考点。
